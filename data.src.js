		...
		g.extend(u.prototype, {
			...
			getColumnDistribution: function () {
				var b = this.chartOptions,
                    ...
                    d = [],
                    f = function (b) {
                    	return (g.seriesTypes[b || "line"].prototype.pointArrayMap || [0])
                            .length
                    },
				...
				m(a && a.seriesMapping || [], function (a) {
					var d = new n,
                        r, v = c[t] || f(e),
                        q = g.seriesTypes[((b && b.series || [])[t] || {})
                            .type || e || "line"].prototype.pointArrayMap || ["y"];
			...
			parseDate: function (b) {
				...
				if (a) d = a(b);
					...
					c || (c = Date.parse(b), "object" === typeof c && null !== c && c.getTime ? d = c.getTime() - 6E4 * c.getTimezoneOffset() : x(c) && (d = c - 6E4 * (new Date(c))
                        .getTimezoneOffset()))
				}
				return d
			},
